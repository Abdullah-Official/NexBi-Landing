...
const HeroSection = () => {
  return (
    <section className="flex flex-col items-center justify-center text-center p-12 text-white">
      <h1 className="hero_heading py-4 text-3xl md:text-4xl lg:text-6xl font-bold mb-6 max-w-3xl">
