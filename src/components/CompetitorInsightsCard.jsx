...
const CompetitorInsightsCard = ({formData, handleChange, handleSubmit, isLoading}) => {
      ...
      <div className="relative py-6 px-8 card_wrapper rounded-[28px] max-w-md text-center text-white shadow-lg overflow-hidden">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <button
            disabled={isLoading}
            type="submit"
            className="flex items-center disabled:cursor-not-allowed justify-center text-sm gap-3 w-full py-3.5 !mt-6 text-center font-semibold text-white bg-[#0773ED] rounded-full hover:bg-blue-700 focus:outline-none"
          >
